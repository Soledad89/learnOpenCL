...
struct paramStruct
{
    ...
    cl::NDRange globalNDRange;  //Total number of work items
    cl::NDRange localNDRange;   //Work items in each work-group
...
void InitParams(int argc, char* argv[])
{
    ...
    params.globalNDRange = cl::NDRange(params.nWidth, params.nHeight);
    params.localNDRange  = cl::NDRange(32,32);

    params.kernelFile = "src/kernels.cl";
    params.kernelNames.push_back("Convolve");
    params.kernelNames.push_back("Convolve_Unroll");
    params.kernelNames.push_back("Convolve_UnrollIf");
    params.kernelNames.push_back("Convolve_Def");
    params.kernelNames.push_back("Convolve_Def_Unroll");
    params.kernelNames.push_back("Convolve_Def_UnrollIf");
    params.kernelNames.push_back("Convolve_Float4");
    params.kernelNames.push_back("Convolve_Float4If");
    params.kernelNames.push_back("Convolve_Def_Float4");
    params.kernelNames.push_back("Convolve_Def_Float4If");
